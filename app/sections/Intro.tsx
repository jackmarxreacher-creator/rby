...
export default function Intro() {
  return (
    <section className="bg-[#fcfbf8] py-16 px-4 md:px-12">
      <div className="max-w-7xl mx-auto grid px-18 sm:px-8 grid-cols-1 md:grid-cols-2 gap-12 items-center">
        {/* Text Section */}
        <motion.div
          className="space-y-6"
        ...
        >
          ...
          <p className="text-base text-gray-700 text-justify sm:text-left eading-relaxed">
