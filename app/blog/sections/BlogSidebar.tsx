...
const CATEGORIES = ["Distribution", "Logistics", "Partnerships", "Innovation", "Sustainability", "News"] as const;

/* ----------  server helpers  ---------- */
async function getRecent() {
  return listPosts(true); // published only
}
...
async function getCategoryCounts() {
  return Promise.all(
    CATEGORIES.map(async (cat) => ({
      category: cat,
      count: (await listPosts(true, cat)).length,
    }))
  );
}
...
export default async function BlogSidebar({ searchQuery, setSearchQuery }: Props) {
...
// const categories = ["Distribution", "Logistics", "Partnerships", "Innovation", "Sustainability", "News"];

// /* ----  server helper  ---- */
// async function getRecent() {
//   return listPosts(true); // only published
// }
