...
export default function BlogList({ posts, total, currentPage, onPageChange }: Props) {
  ...
  useEffect(() => {
    ...
    if (blogListRef.current) {
      const top = blogListRef.current.getBoundingClientRect().top + window.pageYOffset - 80;
