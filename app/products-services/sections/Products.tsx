          ...
          {currentProducts.map((product, index) => (
            ...
            >
              ...
              <div
                ...
                style={{ backgroundImage: "url(/images/banners/bg2.png)" }}
              >
                <Image
                  src={thumb(product.image)} // product thumbnail
                  alt={product.name}
                  fill
              ...
              <div className="p-6">
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <h3 className="text-xl font-semibold text-[#be965b] mb-2 truncate">
                ...
                {/* compact: size | uom | case (single row) */}
                <div className="flex items-center justify-between gap-4 text-sm text-gray-600 mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    <FiLayers className="h-4 w-4 text-[#7b2e2e]" />
                    <span className="font-medium">{product.uom ?? '-'}</span>
                  </div>

                  <div className="flex items-center gap-2">
                    <MdInventory className="h-4 w-4 text-[#7b2e2e]" />
